...
extension Clients {
  final class OrganizationVpcFlowLogsServiceRetry: OrganizationVpcFlowLogsServiceStub {
    let inner: any OrganizationVpcFlowLogsServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(
      _ inner: any OrganizationVpcFlowLogsServiceStub, options: GoogleCloudGax.ClientOptions
    ) {
      self.inner = inner
