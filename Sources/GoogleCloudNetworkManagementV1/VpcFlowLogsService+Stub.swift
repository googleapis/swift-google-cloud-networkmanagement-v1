...
extension Clients {
  protocol VpcFlowLogsServiceStub {
  ...
  class VpcFlowLogsServiceTransport: VpcFlowLogsServiceStub {
    ...
    public func queryOrgVpcFlowLogsConfigs(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudNetworkManagementV1.QueryOrgVpcFlowLogsConfigsResponse.self, from: data)
    }
    ...
    public func showEffectiveFlowLogsConfigs(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudNetworkManagementV1.ShowEffectiveFlowLogsConfigsResponse.self, from: data)
    }
