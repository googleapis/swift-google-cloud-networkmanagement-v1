  ...
  final class ReachabilityServiceLogging: ReachabilityServiceStub {
    ...
    public func listConnectivityTests(
      ...
      try await self._intercept(
        ...
        action: {
          (r: ListConnectivityTestsRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func getConnectivityTest(
      ...
      try await self._intercept(
        ...
        action: {
          (r: GetConnectivityTestRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func createConnectivityTest(
      ...
      try await self._intercept(
        ...
        action: {
          (r: CreateConnectivityTestRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func updateConnectivityTest(
      ...
      try await self._intercept(
        ...
        action: {
          (r: UpdateConnectivityTestRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
    ...
    public func rerunConnectivityTest(
      ...
      try await self._intercept(
        ...
        action: {
          (r: RerunConnectivityTestRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
    ...
    public func deleteConnectivityTest(
      ...
      try await self._intercept(
        ...
        action: {
          (r: DeleteConnectivityTestRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
