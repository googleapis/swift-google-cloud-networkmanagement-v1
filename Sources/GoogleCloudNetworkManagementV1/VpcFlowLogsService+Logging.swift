  ...
  final class VpcFlowLogsServiceLogging: VpcFlowLogsServiceStub {
    ...
    public func queryOrgVpcFlowLogsConfigs(
      ...
      try await self._intercept(
        ...
        action: {
          (r: QueryOrgVpcFlowLogsConfigsRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func showEffectiveFlowLogsConfigs(
      ...
      try await self._intercept(
        ...
        action: {
          (r: ShowEffectiveFlowLogsConfigsRequest, o: GoogleGax.RequestOptions) async throws
